...
inline constexpr const char* kVersionGitCommitHash = "224a4fd";
inline constexpr const char* kVersionGitBranch = "new-dev";
inline constexpr int kVersionGitCommits = 60;
...
inline constexpr const char* kVersionBuild = "build 60 (new-dev-224a4fd)";
