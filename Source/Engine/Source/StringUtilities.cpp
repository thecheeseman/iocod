...
String Capitalize(const String& string)
{
    ...
    if (!result.empty())
        result.front() = NarrowCast<char>(std::toupper(result.front()));
    return result;
}
...
String ToLower(const String& string)
{
    ...
    std::transform(result.begin(), result.end(), result.begin(),
                   [](char c) { return NarrowCast<char>(std::tolower(c)); });
    return result;
}
...
String ToUpper(const String& string)
{
    String result = string;
    std::transform(result.begin(), result.end(), result.begin(),
                   [](char c) { return NarrowCast<char>(std::toupper(c)); });
    return result;
}
