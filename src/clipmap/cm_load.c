...
*/
static void cmod_load_shaders(struct header_lump *l)
{
    struct shader *in;
    int count;
...
*/
static void cmod_load_planes(struct header_lump *l)
{
    struct bsp_plane *in;
    struct plane *out;
    int i, j, count, bits;
...
*/
static void cmod_load_brushes(struct header_lump *l1, struct header_lump *l2)
{
...
*/
static void cmod_load_nodes(struct header_lump *l)
{
    struct bsp_node *in;
    struct node *out;
    int i, j, count;
...
*/
static void cmod_load_leafs(struct header_lump *l)
{
    struct bsp_leaf *in;
    struct leaf *out;
    int i, count;
...
*/
static void cmod_load_leaf_brushes(struct header_lump *l)
{
...
*/
static void cmod_load_leaf_surfaces(struct header_lump *l)
{
...
*/
static void cmod_load_leaf_patches(struct header_lump *l1, 
                                   struct header_lump *l2,
...
*/
static void cmod_load_submodels(struct header_lump *l)
{
    struct bsp_model *in;
    struct model *out;
...
*/
static void cmod_load_visibility(struct header_lump *l)
{
    byte *buf;
...
*/
static void cmod_load_entity_string(struct header_lump *l)
{
 ...
 * @param header 
*/
static void print_bsp_info(const char *mapname, int length, 
