...
bool SCRIPT_UNUSED (*_scr_is_thread_alive)(uint16_t thread);
...
void SCRIPT_UNUSED (*_scr_spacer1)(void);
void SCRIPT_UNUSED (*_scr_spacer2)(void);
...
void SCRIPT_UNUSED (*_scr_get_checksum)(int32_t a);
void SCRIPT_UNUSED (*_scr_has_source_files)(void);
void SCRIPT_UNUSED (*_scr_save_source)(int32_t a);
void SCRIPT_UNUSED (*_scr_load_source)(int32_t a);
void SCRIPT_UNUSED (*_scr_skip_source)(int32_t a);
void SCRIPT_UNUSED (*_scr_save_pre)(int32_t a);
void SCRIPT_UNUSED (*_scr_save_post)(int32_t a);
void SCRIPT_UNUSED (*_scr_save_shutdown)(void);
void SCRIPT_UNUSED (*_scr_spacer3)(void);
void SCRIPT_UNUSED (*_scr_load_pre)(int32_t a, int32_t b);
void SCRIPT_UNUSED (*_scr_load_shutdown)(void);
void SCRIPT_UNUSED (*_scr_spacer4)(void);
...
uint16_t SCRIPT_UNUSED (*_scr_convert_thread_to_save)(uint16_t thread);
uint16_t SCRIPT_UNUSED (*_scr_convert_thread_from_load)(uint16_t thread);
...
uint16_t SCRIPT_UNUSED (*_scr_create_canonical_filename)(int32_t a);
...
void SCRIPT_UNUSED (*_scr_get_anims)(int32_t a);
