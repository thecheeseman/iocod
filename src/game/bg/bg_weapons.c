...
void set_up_weapon_info(void)
{
    ...
    com_memset(ammo_types, 0, sizeof(ammo_types));
    com_memset(ammo_max, 0, sizeof(int));
    ammo_types[0] = "none";
    num_ammo_types = 1;

    // zero clip types array
    com_memset(clip_types, 0, sizeof(clip_types));
    com_memset(clip_max, 0, sizeof(int));
    clip_types[0] = "none";
    num_clip_types = 1;
        
    com_memset(weapons, 0, sizeof(weapons));
