...
enum game_imports {
    ...
    G_XANIM_CREATE_TREE,
    G_XANIM_CREATE_SMALL_TREE,
    G_XANIM_FREE_SMALL_TREE,
    ...
    G_XANIM_CLEAR_TREE_GOAL_WEIGHTS,
    G_XANIM_CLEAR_GOAL_WEIGHT,
    G_XANIM_CLEAR_TREE_GOAL_WEIGHTS_STRICT,
    G_XANIM_SET_COMPLETE_GOAL_WEIGHT_KNOB,
    G_XANIM_SET_COMPLETE_GOAL_WEIGHT_KNOB_ALL,
    G_XANIM_SET_ANIM_RATE,
    G_XANIM_SET_TIME,
    G_XANIM_SET_GOAL_WEIGHT_KNOB,
    G_XANIM_CLEAR_TREE,
    G_XANIM_HAS_TIME,
    G_XANIM_IS_PRIMITIVE,
    G_XANIM_GET_LENGTH,
    G_XANIM_GET_LENGTH_SECONDS,
    G_XANIM_SET_COMPLETE_GOAL_WEIGHT,
    G_XANIM_SET_GOAL_WEIGHT,
    G_XANIM_CALC_ABS_DELTA,
    G_XANIM_CALC_DELTA,
    G_XANIM_GET_REL_DELTA,
    G_XANIM_GET_ABS_DELTA,
    G_XANIM_IS_LOOPED,
    G_XANIM_NOTETRACK_EXISTS,
    G_XANIM_GET_TIME,
    G_XANIM_GET_WEIGHT,

    G_DOBJ_DUMP_INFO,
    G_DOBJ_CREATE_SKEL_FOR_BONE,
    G_DOBJ_CREATE_SKEL_FOR_BONES,
    G_DOBJ_UPDATE_SERVER_TIME,
    G_DOBJ_INIT_SERVER_TIME,
    G_DOBJ_GET_HIERARCHY_BITS,
    G_DOBJ_CALC_ANIM,
    G_DOBJ_CALC_SKEL,

    G_XANIM_LOAD_ANIM_TREE,
    G_XANIM_SAVE_ANIM_TREE,
    G_XANIM_CLONE_ANIM_TREE,

    G_DOBJ_NUM_BONES,
    G_DOBJ_GET_BONE_INDEX,
    G_DOBJ_GET_MATRIX_ARRAY,
    G_DOBJ_DISPLAY_ANIM,

    G_XANIM_HAS_FINISHED,
    G_XANIM_GET_NUM_CHILDREN,
    G_XANIM_GET_CHILD_AT,

    G_XMODEL_GET_NUM_BONES,
    G_XMODEL_GET_BONE_NAMES,

    G_DOBJ_GET_ROT_TRANS_ARRAY,
    G_DOBJ_SET_ROT_TRANS_INDEX,
    G_DOBJ_SET_CONTROL_ROT_TRANS_INDEX,
    ...
    G_GET_WEAPON_INFO_MEMORY,
    G_FREE_WEAPON_INFO_MEMORY,

    G_FREE_CLIENT_SCRIPT_PERS,
    G_RESET_ENTITY_PARSE_POINT
    //! added in 1.1
};
